...
export const STARGATE_DEFAULT_BLOCK_CONFIRMATIONS: Record<
  keyof typeof STARGATE_CHAIN_ID,
  number
> = {
  [ChainId.ETHEREUM]: 15,
  [ChainId.BSC]: 20,
...
export const STARGATE_CONFIRMATION_SECONDS: Record<
  keyof typeof STARGATE_CHAIN_ID,
  number
> = {
  [ChainId.ETHEREUM]:
    STARGATE_DEFAULT_BLOCK_CONFIRMATIONS[ChainId.ETHEREUM] * 15,
  [ChainId.BSC]: STARGATE_DEFAULT_BLOCK_CONFIRMATIONS[ChainId.BSC] * 3,
  [ChainId.AVALANCHE]:
    STARGATE_DEFAULT_BLOCK_CONFIRMATIONS[ChainId.AVALANCHE] * 3,
  [ChainId.POLYGON]: STARGATE_DEFAULT_BLOCK_CONFIRMATIONS[ChainId.POLYGON] * 3,
  [ChainId.ARBITRUM]:
    STARGATE_DEFAULT_BLOCK_CONFIRMATIONS[ChainId.ARBITRUM] * 15,
  [ChainId.OPTIMISM]:
    STARGATE_DEFAULT_BLOCK_CONFIRMATIONS[ChainId.OPTIMISM] * 15,
  [ChainId.FANTOM]: STARGATE_DEFAULT_BLOCK_CONFIRMATIONS[ChainId.FANTOM] * 2,
  [ChainId.METIS]: STARGATE_DEFAULT_BLOCK_CONFIRMATIONS[ChainId.METIS] * 7,
  [ChainId.KAVA]: STARGATE_DEFAULT_BLOCK_CONFIRMATIONS[ChainId.KAVA] * 7,
  [ChainId.BASE]: STARGATE_DEFAULT_BLOCK_CONFIRMATIONS[ChainId.BASE] * 15,
  [ChainId.LINEA]: STARGATE_DEFAULT_BLOCK_CONFIRMATIONS[ChainId.LINEA] * 12,
}
